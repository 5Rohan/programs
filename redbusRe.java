...
4.Pick onward date as 1st Monday of next month
5.Click on 'Search Buses'  and print total busses
...
public class redbusRe {
	...
	public static void main(String[] args) throws Exception {
		...
		wait.until(ExpectedConditions.elementToBeClickable(rArraow));
		
		LocalDate now = LocalDate.now().plusMonths(1);

		LocalDate firstMonday = now.with(TemporalAdjusters.firstInMonth(DayOfWeek.MONDAY));
		int date = firstMonday.getDayOfMonth();//+" "+firstMonday.getMonth();
		System.out.println(firstMonday.getDayOfMonth());//+" "+firstMonday.getMonth());
